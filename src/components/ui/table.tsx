...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-x-auto">
    <table
      ref={ref}
      className={cn(
        "w-full caption-bottom text-left text-sm text-foreground/85",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "[&_tr]:bg-white/40 [&_tr]:text-foreground/70 [&_tr]:uppercase [&_tr]:tracking-wide",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "transition-colors hover:bg-primary/10 data-[state=selected]:bg-primary/15",
      className,
    )}
    {...props}
  />
